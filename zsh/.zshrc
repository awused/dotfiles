...
alias ytvt='yt-dlp --no-mtime --output "/storage/usr/desuwa/Videos/Vtubers/%(title)s-%(id)s.%(ext)s" --'
alias ytvts='yt-dlp --write-sub --no-mtime --output "/storage/usr/desuwa/Videos/Vtubers/%(title)s-%(id)s.%(ext)s" --'
