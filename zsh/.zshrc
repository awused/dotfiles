...
alias ytv='youtube-dl --no-mtime --output "/storage/usr/desuwa/Videos/%(title)s-%(id)s.%(ext)s" --'
alias ytvt='youtube-dl --no-mtime --output "/storage/usr/desuwa/Videos/Vtubers/%(title)s-%(id)s.%(ext)s" --'
